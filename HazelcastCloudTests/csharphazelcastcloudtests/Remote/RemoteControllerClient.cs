...
namespace Hazelcast.Testing.Remote
{
    ...
    public class RemoteControllerClient : RemoteController.Client, IRemoteControllerClient
    {
        ...
        public Task<CloudCluster> StopHazelcastCloudCluster(string clusterId,
            CancellationToken cancellationToken = default)
            => WithLock(token => stopHazelcastCloudCluster(clusterId, token), cancellationToken);

        public Task<CloudCluster> ResumeHazelcastCloudCluster(string clusterId,
            CancellationToken cancellationToken = default)
            => WithLock(token => resumeHazelcastCloudCluster(clusterId, token), cancellationToken);

        public Task<bool> DeleteHazelcastCloudCluster(string clusterId,
            CancellationToken cancellationToken = default)
            => WithLock(token => deleteHazelcastCloudCluster(clusterId, token), cancellationToken);
    }
}
